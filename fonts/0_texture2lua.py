...
parser.add_argument("filename", type=must_be_png)
...
# Load meta data
metadataPath = os.path.join(os.path.dirname(args.filename), "metadata.json")
metadata = {}
...
export_filename = os.path.basename(args.filename)[:-4]
